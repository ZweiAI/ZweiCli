...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZWEI_CALLER", () => {
    process.env["ZWEI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZWEI_CALLER", () => {
    process.env["ZWEI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZWEI_CALLER", () => {
    process.env["ZWEI_CALLER"] = "unknown"
