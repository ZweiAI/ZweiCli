...
export class Session2 extends HeyApiClient {
  ...
  public clear<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).delete<SessionClearResponses, SessionClearErrors, ThrowOnError>({
...
export class Dual extends HeyApiClient {
  /**
   * Start an interactive dual-agent run
   *
  ...
  public start<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      dualStartRequest?: DualStartRequest
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "dualStartRequest", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<DualStartResponses, DualStartErrors, ThrowOnError>({
      url: "/dual",
      ...options,
      ...params,
      headers: {
  ...
  public advance<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<DualAdvanceResponses, DualAdvanceErrors, ThrowOnError>({
  ...
  public abort<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<DualAbortResponses, DualAbortErrors, ThrowOnError>({
  ...
  /**
   * Swap Student and/or Supervisor model
   *
  ...
  public model<ThrowOnError extends boolean = false>(
    parameters: {
      ...
      directory?: string
      workspace?: string
      dualModelRequest?: DualModelRequest
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            ...
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "dualModelRequest", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<DualModelResponses, DualModelErrors, ThrowOnError>({
...
export class OpencodeClient extends HeyApiClient {
  ...
  private _dual?: Dual
  get dual(): Dual {
    return (this._dual ??= new Dual({ client: this.client }))
  }
