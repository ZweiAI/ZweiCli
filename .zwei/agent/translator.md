...
- Also apply locale-specific guidance from `.zwei/glossary/<locale>.md` when available (for example, `zh-cn.md`).
...
.zwei/agents/
.zwei/commands/
.zwei/commands/test.md
.zwei/modes/
.zwei/plans/*.md
.zwei/plugins/
.zwei/skills/<name>/SKILL.md
.zwei/skills/git-release/SKILL.md
.zwei/tools/
.well-known/opencode
...
<project-root>/.zwei/themes/*.json
<providerId>/<modelId>
<your-project>/.zwei/plugins/
~
~/...
~/.agents/skills/*/SKILL.md
~/.agents/skills/<name>/SKILL.md
