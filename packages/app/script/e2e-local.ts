...
const keepSandbox = process.env.ZWEI_E2E_KEEP_SANDBOX === "1"

const serverEnv = {
  ...process.env,
  ZWEI_DISABLE_SHARE: process.env.ZWEI_DISABLE_SHARE ?? "true",
  ZWEI_DISABLE_LSP_DOWNLOAD: "true",
  ZWEI_DISABLE_DEFAULT_PLUGINS: "true",
  ZWEI_EXPERIMENTAL_DISABLE_FILEWATCHER: "true",
  ZWEI_TEST_HOME: path.join(sandbox, "home"),
  XDG_DATA_HOME: path.join(sandbox, "share"),
  XDG_CACHE_HOME: path.join(sandbox, "cache"),
  XDG_CONFIG_HOME: path.join(sandbox, "config"),
  XDG_STATE_HOME: path.join(sandbox, "state"),
  ZWEI_E2E_PROJECT_DIR: repoDir,
  ZWEI_E2E_SESSION_TITLE: "E2E Session",
  ZWEI_E2E_MESSAGE: "Seeded for UI e2e",
  ZWEI_E2E_MODEL: process.env.ZWEI_E2E_MODEL ?? "opencode/gpt-5-nano",
  ZWEI_CLIENT: "app",
  ZWEI_STRICT_CONFIG_DEPS: "true",
...
const runnerEnv = {
  ...
  VITE_ZWEI_SERVER_HOST: "127.0.0.1",
  VITE_ZWEI_SERVER_PORT: String(serverPort),
