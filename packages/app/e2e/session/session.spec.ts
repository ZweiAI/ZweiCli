...
const shareDisabled = process.env.ZWEI_DISABLE_SHARE === "true" || process.env.ZWEI_DISABLE_SHARE === "1"
...
test("session can be shared and unshared via header button", async ({ page, project }) => {
  test.skip(shareDisabled, "Share is disabled in this environment (ZWEI_DISABLE_SHARE).")
