...
const releaseId = process.env.ZWEI_RELEASE
if (!releaseId) throw new Error("ZWEI_RELEASE is required")

const version = process.env.ZWEI_VERSION
if (!version) throw new Error("ZWEI_VERSION is required")
