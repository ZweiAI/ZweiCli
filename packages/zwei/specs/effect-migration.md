...
Practical reference for new and migrated Effect code in `packages/zwei`.
...
Tool tests should use the existing Effect helpers in `packages/zwei/test/lib/effect.ts`:
