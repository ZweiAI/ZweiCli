...
beforeAll(async () => {
  ...
  mock.module("@zwei/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@zwei/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@zwei/ui/icon", () => ({ Icon: () => null }))
  mock.module("@zwei/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
