...
Use for core server issues in `packages/zwei/`, excluding `packages/zwei/src/cli/cmd/tui/`.
...
TUI (`packages/zwei/src/cli/cmd/tui/...`):
...
Core (`packages/zwei/...`, excluding TUI subtree):
