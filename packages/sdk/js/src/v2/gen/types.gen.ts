...
export type EventDualPhaseStarted = {
  type: "dual.phase.started"
  properties: {
    runID: string
    round: number
    phase: "student_r0" | "supervisor_r0" | "student" | "supervisor"
    timestamp: number
  }
}

export type EventDualPhaseCompleted = {
  type: "dual.phase.completed"
  properties: {
    runID: string
    round: number
    phase: "student_r0" | "supervisor_r0" | "student" | "supervisor"
    durationMs: number
    success: boolean
    errorKind?: "transient" | "permission" | "model" | "other"
    errorMessage?: string
    timestamp: number
  }
}

export type EventDualVerdict = {
  type: "dual.verdict"
  properties: {
    runID: string
    round: number
...
export type EventDualTraceExtracted = {
  type: "dual.trace.extracted"
  properties: {
    runID: string
    round: number
...
export type EventDualBudgetCheck = {
  type: "dual.budget.check"
  properties: {
    runID: string
    round: number
    phase: "student_r0" | "supervisor_r0" | "student" | "supervisor"
...
export type EventDualFinished = {
  type: "dual.finished"
  properties: {
    runID: string
    status: "pass" | "fail" | "error" | "budget_exceeded"
    rounds: number
    totalCost?: number
...
export type Event =
  ...
  | EventPtyDeleted
  | EventDualStarted
  | EventDualPhaseStarted
  | EventDualPhaseCompleted
  | EventDualVerdict
  | EventDualTraceExtracted
  | EventDualBudgetCheck
  | EventDualRetry
  | EventDualFinished
  | EventMessageUpdated
  | EventMessageRemoved
...
export type DualModelSpec = {
  providerID: string
  modelID: string
}

export type DualSubtaskSpec = {
  agent: string
  description: string
  prompt: string
  model?: DualModelSpec
...
export type DualStartRequest = {
  task: string
  model?: DualModelSpec
  studentModel?: DualModelSpec
  supervisorModel?: DualModelSpec
  maxRounds?: number
  mode?: "fast" | "strict" | "auto"
  testCmd?: string
  subtasks?: Array<DualSubtaskSpec>
  studentSessionID?: string
  supervisorSessionID?: string
  parentSessionID?: string
}

export type DualModelRequest = {
  student?: DualModelSpec | null
  supervisor?: DualModelSpec | null
}
...
export type DualStartData = {
  body?: DualStartRequest
  path?: never
  query?: {
    directory?: string
    workspace?: string
...
export type DualStartError = DualStartErrors[keyof DualStartErrors]

export type DualStartResponses = {
  /**
   * Run started
   */
  200: DualStartResponse
}

export type DualStartResponse2 = DualStartResponses[keyof DualStartResponses]

export type DualAdvanceData = {
  body?: never
  path: {
    runID: string
  }
  ...
  url: "/dual/{runID}/advance"
}

export type DualAdvanceErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type DualAdvanceError = DualAdvanceErrors[keyof DualAdvanceErrors]

export type DualAdvanceResponses = {
  /**
   * Advance signalled
   */
  200: {
...
export type DualAdvanceResponse = DualAdvanceResponses[keyof DualAdvanceResponses]

export type DualAbortData = {
  body?: {
    reason?: string
  }
  path: {
  ...
  url: "/dual/{runID}/abort"
}

export type DualAbortErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type DualAbortError = DualAbortErrors[keyof DualAbortErrors]

export type DualAbortResponses = {
  /**
   * Abort signalled
   */
  200: {
...
export type DualAbortResponse = DualAbortResponses[keyof DualAbortResponses]

export type DualModelData = {
  body?: DualModelRequest
  path: {
    runID: string
  }
  query?: {
  ...
  url: "/dual/{runID}/model"
}

export type DualModelErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type DualModelError = DualModelErrors[keyof DualModelErrors]

export type DualModelResponses = {
  /**
   * Model updated
   */
  200: {
...
export type DualModelResponse = DualModelResponses[keyof DualModelResponses]
